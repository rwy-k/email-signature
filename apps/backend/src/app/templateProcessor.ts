...
export class TemplateProcessor {
   ...
   */
  public static getAllTemplates(): Array<{ id: string; content: string }> {
    try {
   ...
   */
  public static renderHtml(templateId: string, userData: any): string {
   ...
   */
  public static renderPlainText(userData: any): string {
   ...
   */
  private static processTemplate(template: string, userData: any): string {
    try {
